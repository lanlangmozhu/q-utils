...
- 创建自定义脚本自动转换文档格式
- 自动提取函数签名、参数、返回值、示例代码和源代码实现

#### 文档项目独立化
- 创建独立的文档项目（`docs/package.json`）
- 配置 TypeDoc 和 VitePress
- 添加文档生成脚本和自定义组件

#### 文档内容完善
- 更新首页和快速开始指南
- 完善命名空间导入说明
- 完善 Tree Shaking 使用说明
- 完善 TypeScript 类型支持说明

### 配置更新
- 更新 `.gitignore` 添加文档相关忽略项
- 将 `typedoc.json` 移动到 `docs/` 目录
- 删除旧的 VitePress 配置文件
