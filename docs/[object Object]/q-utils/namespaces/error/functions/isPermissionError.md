...
[qh5-utils](../../../../README.md) / [error](../README.md) / isPermissionError

# Function: isPermissionError()

> **isPermissionError**(`error`): `error is CustomError`

Defined in: [error/check.ts:60](https://github.com/lanlangmozhu/qh5-utils/blob/main/src/error/check.ts#L60)
