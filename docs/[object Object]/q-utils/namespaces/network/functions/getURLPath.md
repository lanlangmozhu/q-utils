...
[qh5-utils](../../../../README.md) / [network](../README.md) / getURLPath

# Function: getURLPath()

> **getURLPath**(`url?`): `string`

Defined in: [network/url.ts:128](https://github.com/lanlangmozhu/qh5-utils/blob/main/src/network/url.ts#L128)
