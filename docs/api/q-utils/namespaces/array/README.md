...
- [chunkGroups](functions/chunkGroups.md)
- [splitIntoGroups](functions/splitIntoGroups.md)
- [move](functions/move.md)
- [rotate](functions/rotate.md)
- [swap](functions/swap.md)
- [randomItem](functions/randomItem.md)
- [randomItems](functions/randomItems.md)
- [shuffle](functions/shuffle.md)
- [randomRange](functions/randomRange.md)
- [sortBy](functions/sortBy.md)
- [sortByMultiple](functions/sortByMultiple.md)
- [sortWith](functions/sortWith.md)
- [stableSort](functions/stableSort.md)
...
- [findTreeNode](functions/findTreeNode.md)
- [filterTree](functions/filterTree.md)
