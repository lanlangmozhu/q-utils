...
- [compareIgnoreCase](functions/compareIgnoreCase.md)
- [equals](functions/equals.md)
- [equalsIgnoreCase](functions/equalsIgnoreCase.md)
- [similarity](functions/similarity.md)
- [encodeUrl](functions/encodeUrl.md)
- [decodeUrl](functions/decodeUrl.md)
...
- [trimLeft](functions/trimLeft.md)
- [trimRight](functions/trimRight.md)
- [normalizeSpace](functions/normalizeSpace.md)
...
- [dasherize](functions/dasherize.md)
